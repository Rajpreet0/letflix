...
const MovieCard: React.FC<MovieCardProps> = ({data}) => {
    ...
    return (
      <div className='group bg-zinc-900 col-span relative h-[12vw]'>
        ...
        src={data.thumbnailUrl} draggable={false} alt='Thumbnail'></img>
        <div className='opacity-0 absolute top-0 transition duration-200 z-10 invisible 
        sm:visible delay-300 w-full scale-0 group-hover:scale-110 group-hover:-translate-y-[6vw] group-hover:translate-x-[2vw]
